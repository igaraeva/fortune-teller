...
function generateFortune(event) {
  ...
  let prompt = `Generate a personal future prediction based on a person's date of birth: ${dateOfBirth.value}. The prediction should be short, one sentence long with NO headings or subheadings. You should avoid stating the current year. If ${dateOfBirth.value} does not have any numbers, prompt the user to input their date of birth in the following format: DD/MM/YYYY`;
  let context =
